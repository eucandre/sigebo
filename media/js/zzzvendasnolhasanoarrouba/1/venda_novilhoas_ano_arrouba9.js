...
var venda_novilhoas_ano_arrouba9 = document.getElementById("id_vendas_novilhoas_ano_arrouba9");
...
function efetuaCalculo(){
  ...
  venda_novilhoas_ano_arrouba9.innerHTML = ((parseInt(vacas.value)-(parseInt(vacas.value)-(parseInt(vacas.value)*(parseInt(fertilidade.value)/100))))
