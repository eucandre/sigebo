...
var venda_novilhoas_ano_arrouba3 = document.getElementById("id_vendas_novilhoas_ano_arrouba3");
...
function efetuaCalculo(){
  ...
  venda_novilhoas_ano_arrouba3.innerHTML = (((parseInt(vacas.value)-(parseInt(vacas.value)-(parseInt(vacas.value)*(parseInt(fertilidade.value)/100))))
