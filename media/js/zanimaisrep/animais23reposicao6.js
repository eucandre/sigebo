...
var animais23reposicao6 = document.getElementById("id_animais_23_reposicao6");

function efetuaCalculo(){
  //Cálculo simples de potência só pra ilustrar
  animais23reposicao6.innerHTML = ((parseInt(reposicao.value)/100)*parseInt(vacas.value)).toFixed(2);
