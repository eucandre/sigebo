...
var venda_novilhoas_ano7 = document.getElementById("id_vendas_novilhoas_ano7");
...
function efetuaCalculo(){
  ...
  venda_novilhoas_ano7.innerHTML = (((parseInt(vacas.value)-(parseInt(vacas.value)-(parseInt(vacas.value)*(parseInt(fertilidade.value)/100))))
