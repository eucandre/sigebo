...
var venda_novilhoas_ano6 = document.getElementById("id_vendas_novilhoas_ano6");
...
function efetuaCalculo(){
  ...
  venda_novilhoas_ano6.innerHTML = ((parseInt(vacas.value)-(parseInt(vacas.value)-(parseInt(vacas.value)*(parseInt(fertilidade.value)/100))))
