...
var venda_novilhoas_ano4 = document.getElementById("id_vendas_novilhoas_ano4");
...
function efetuaCalculo(){
  ...
  venda_novilhoas_ano4.innerHTML = ((parseInt(vacas.value)-(parseInt(vacas.value)-(parseInt(vacas.value)*(parseInt(fertilidade.value)/100))))
