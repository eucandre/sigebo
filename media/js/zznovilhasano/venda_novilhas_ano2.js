...
var venda_novilhoas_ano2 = document.getElementById("id_vendas_novilhoas_ano2");
...
function efetuaCalculo(){
  ...
  venda_novilhoas_ano2.innerHTML = ((parseInt(vacas.value)-(parseInt(vacas.value)-(parseInt(vacas.value)*(parseInt(fertilidade.value)/100))))
