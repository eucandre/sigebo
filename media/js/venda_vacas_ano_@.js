...
function efetuaCalculo(){
  ...
  venda_vacas_ano_arrouba.innerHTML = ((parseInt(vacas.value)-(parseInt(vacas.value)*(parseInt(fertilidade.value)/100)))*parseInt(peso_medio_vacas_arrouba.value)).fixed(2);
