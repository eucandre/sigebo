...
var de12anos4 = document.getElementById("id_de12anos4");
function efetuaCalculo() {
    de12anos4.innerHTML = parseInt(vacas.value) - (parseInt(vacas.value) - (parseInt(vacas.value) * (parseInt(fertilidade.value) / 100))) -
