...
var de12anos7 = document.getElementById("id_de12anos7");
function efetuaCalculo() {
    de12anos7.innerHTML = parseInt(vacas.value) - (parseInt(vacas.value) - (parseInt(vacas.value) * (parseInt(fertilidade.value) / 100))) -
