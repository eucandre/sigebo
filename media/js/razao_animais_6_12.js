...
function efetuaCalculo(){
  ...
  razao_animais_6_12.innerHTML = (((parseInt(animais_6_12.value)*(parseInt(peso_animais_6_12.value)))/450)/1.5/(parseInt(parseInt(tempo_descanso.value)/parseInt(tempo_pastejo.value))+1).value).toFixed(2);
}
