...
var animais23reposicao2 = document.getElementById("id_animais_23_reposicao2");

function efetuaCalculo(){
  //Cálculo simples de potência só pra ilustrar
  animais23reposicao2.innerHTML = ((parseInt(reposicao.value)/100)*parseInt(vacas.value)).toFixed(2);
