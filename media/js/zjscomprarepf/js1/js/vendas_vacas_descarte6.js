...
var vendas_vacas_descarte_ano6 = document.getElementById("id_vendas_vacas_descarte_ano6");

function efetuaCalculo(){
  //Cálculo simples de potência só pra ilustrar
  vendas_vacas_descarte_ano6.innerHTML = (parseInt(vacas.value)-(parseInt(vacas.value)*(parseInt(fertilidade.value)/100))).toFixed(2);
