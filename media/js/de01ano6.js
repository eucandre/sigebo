...
var de01ano6 = document.getElementById("id_de01ano6");

function efetuaCalculo(){
  //Cálculo simples de potência só pra ilustrar
  de01ano6.innerHTML = (parseInt(vacas.value)-(parseInt(vacas.value)-(parseInt(vacas.value)*(parseInt(fertilidade.value)/100)))).toFixed(2);
