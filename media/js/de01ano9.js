...
var de01ano9= document.getElementById("id_de01ano9");

function efetuaCalculo(){
  //Cálculo simples de potência só pra ilustrar
  de01ano9.innerHTML = (parseInt(vacas.value)-(parseInt(vacas.value)-(parseInt(vacas.value)*(parseInt(fertilidade.value)/100)))).toFixed(2);
