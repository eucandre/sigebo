...
var venda_novilhoas_ano_arrouba = document.getElementById("id_vendas_novilhoas_ano_arrouba");
...
function efetuaCalculo(){
  ...
  venda_novilhoas_ano_arrouba.innerHTML = ((parseInt(vacas.value)-(parseInt(vacas.value)-(parseInt(vacas.value)*(parseInt(fertilidade.value)/100))))
